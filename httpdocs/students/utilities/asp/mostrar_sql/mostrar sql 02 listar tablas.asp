...
<!--7.- LISTADO DE LAS TABLAS -INICIO-->
	...
	<table width="<%=TABLA0700000001ANCHO%>" align="center" cellpadding="0" cellspacing="0" style="table-layout: fixed">
		<TR>
				...
				<%if left(TABLE.name,4)<>"MSys" then%>
                    ...
                    <%if mostrartabla="si" then%>
                        ...
                        <tr bgcolor="<%=trbgcolor%>">
                            ...
                            END IF%>
                            <form method="post" action="<%=IRGENERARCODIGO%>" target="PAGINA00679IFRAME02">
