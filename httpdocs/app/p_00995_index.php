...
-->
<?
echo "<script>console.info('VER: ".$_GET['DEV']."');console.log('LOC: ".$version_pagina."');</script>";
...
>
	...
	<div id="bloquear_giro" style="display:none;">
      ...
      <img style="height: 40%;" src="<? echo $version_pagina_src; ?>images/orientacion4.png">
   </div>
	<?
		include($version_pagina."movil/p_00957_menu.php");
	?>
   ...
   <script>
		$("#p_00995_reloguin").load("http://app.oxbridge.es/sesiones/sesion_04_comprobacion_01_html_01_estructura.php"+
			...
			<?
				if(isset($_GET['DEV']))
				{
					echo '+"&p_0001319_get_dev='.$_GET['DEV'].'"';
				}
			?>
		);
   </script>
   	...
   	<div id="p_00990_over_all_cerrar_mail" onclick="ocultar_mostrar('p_00995_formulario_mail_contenedor');"></div>
		...
		>
			...
			<div class="p_00995_formulario_mail_div" style="float:right;clear:both;">
				<img id="p_00995_formulario_mail_img_cargando" class="img_cargando" src="<? echo $version_pagina_src; ?>images/loading.png" style=" height:2em;display:none">
            <input
   ...
   <div id="p_00995_tutorial" style="display:none;">
	...
	<div id="contenedor" >
      ...
      <div id="head_oxbridge">
      	<img id="head_oxbridge_img" src="<? echo $version_pagina_src; ?>images/OXBRIDGE-logo_2.png" onClick="">
         <img id="head_oxbridge_beta_img" style="height:50%;position: absolute; z-index:-1;" src="<? echo $version_pagina_src; ?>images/beta2.png">
         ...
         <div id="p_00955_head_oxbridge_idioma">
            <img id="p_00955_head_oxbridge_logout" src="<? echo $version_pagina_src; ?>images/logout.png" onclick="ocultar_mostrar('p_00995_formulario_logout_contenedor');" style="display:none;">
            <div id="p_00955_head_oxbridge_idiomas" style="display:none;">

            </div>
         </div>
         <div style="height:100%; display:inline-block; float:right;">
            <img id="head_send_email_img" src="<? echo $version_pagina_src; ?>images/send_email.png" style="display:none;position:absolute;">
            <img id="head_oxbridge_mail" src="<? echo $version_pagina_src; ?>images/boton_mail.png"
               onClick="ocultar_mostrar('p_00995_formulario_mail_contenedor');">
         </div>
			<div id="head_oxbridge_menu_apartados"></div>
      </div>
		<?
			include ($version_pagina."movil/p_00959_claseweb.php");
			include ($version_pagina."movil/p_00960_clases.php");
			include ($version_pagina."movil/p_00958_horario.php");
			include ($version_pagina."movil/p_00961_personal.php");
			include ($version_pagina."movil/smiles/p_00962_smile.php");
		?>
   </div>
...
<style>
   ...
   <div id="p_00995_firma_botones"
   	style="
         ...
         bottom:5%;
  		...
  		"
   >
      <img src="<? echo $version_pagina_src; ?>images/firma_borrar.png" class="p_00995_boton_pad_firma" style=" margin-right:20%;" onclick="signaturePad.clear();" data-action="clear">
      <img src="<? echo $version_pagina_src; ?>images/firma_ok.png" class="p_00995_boton_pad_firma" onclick="signaturePadSave(event);" data-action="save">
   </div>
   ...
   <div id="p_00995_firma" style="display:none;">
   	...
   	<? include $version_pagina."movil/firma/pad/firma.html";?>
      <form enctype="multipart/form-data" id="firma" action="<? echo $version_pagina_src; ?>p_01177_calse_iframe_datos.php?consulta=firma&alumno_id=&dia_lectivo=" method="post">
   ...
   <div id="p_01304_condiciones_esp.php"  style='tab-interval:35.4pt;display:none;'>
   	<? include $version_pagina."p_01304_condiciones_esp.php";?>
   </div>
   <div id="p_01305_condiciones_cat.php"  style='tab-interval:35.4pt;display:none;'>
   	<? include $version_pagina."p_01305_condiciones_cat.php";?>
   </div>
   <div id="p_01306_condiciones_eng.php"  style='tab-interval:35.4pt;display:none;'>
   	<? include $version_pagina."p_01306_condiciones_eng.php";?>
   </div>

   </body>
	<? include($version_pagina."movil/p_00963_foot.php");?>
