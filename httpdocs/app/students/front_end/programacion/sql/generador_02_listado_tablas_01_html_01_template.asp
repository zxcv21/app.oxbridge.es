...
<!--7.- LISTADO DE LAS TABLAS -INICIO-->
	...
	<table width="<%=TABLA0700000001ANCHO%>" cellpadding="0" cellspacing="0" style="table-layout: fixed">
		<TR>
			<td width="<%=TABLA0700000001ANCHOTD01%>PX" height="0" id="P0010211T070000000001TR00TD01"></td>
			<td width="<%=TABLA0700000001ANCHOTD02%>PX" id="P0010211T070000000001TR00TD02"></td>
			<td width="<%=TABLA0700000001ANCHOTD03%>PX" id="P0010211T070000000001TR00TD03"></td>
			<td width="<%=TABLA0700000001ANCHOTD04%>PX" id="P0010211T070000000001TR00TD04"></td>
			<td width="<%=TABLA0700000001ANCHOTD05%>PX" id="P0010211T070000000001TR00TD05"></td>
			<td width="<%=TABLA0700000001ANCHOTD06%>PX" id="P0010211T070000000001TR00TD06"></td>
			<td width="<%=TABLA0700000001ANCHOTD07%>PX" id="P0010211T070000000001TR00TD07"></td>
		</TR>
		<TR>
			<td colspan="7">
		...
		<%else%>
			...
			call p_0010205_asp_f_01_conexion_base_datos( tipo_bd, "", "", "", bdd, p_0010211_asp_f_01_conexion )
			conn.open(p_0010211_asp_f_01_conexion)%>
				...
				<%if left(TABLE.name,4)<>"MSys" then%>
                    ...
                    <%if mostrartabla="si" then%>
                        ...
                        <tr bgcolor="<%=trbgcolor%>">
                            ...
                            END IF%>
                            <form method="post" action="<%=IRGENERARCODIGO%>" target="p_0010208_iframe_tabla_seleccionada_campos">
