			...
			elements: [
				{
					...
					html: '<style type="text/css">' +
						...
						'<p>' +
							...
							'<a target="_blank" href="https://ckeditor.com/">https://ckeditor.com</a>' +
						'</p>' +
						'<p>' +
							lang.help.replace( '$1', '<a target="_blank" href="https://docs.ckeditor.com/user">' + lang.userGuide + '</a>' ) +
						'</p>' +
						'<p>' +
							lang.moreInfo + '<br>' +
							'<a target="_blank" href="https://ckeditor.com/about/license">https://ckeditor.com/about/license</a>' +
						'</p>' +
						'<p>' +
							lang.copy.replace( '$1', '<a target="_blank" href="https://cksource.com/">CKSource</a> - Frederico Knabben' ) +
						'</p>' +
						'</div>'
				}
			]
