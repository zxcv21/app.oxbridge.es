...
<%
	...
	'P�gina 00735
	PAGINACODIGO="00735"
	PAGINADESCRIPCION="Muestra todas las p�ginas web que utilizan la tabla seleccionada"
...
<HEAD>
	...
	<title>00735 P�ginas donde se utiliza la tabla</title>
				...
				<font class="FUENTEGRANDECOLORINFORMATIVOBOLD">
					<%if IDIOMA="CATALAN" THEN%>
						<%if accion="utiliza" then%>
	                        P�gines on s'utilitza la taula "<%=tabla%>"
						<%else%>
	                        P�gines on es modifica el contingut de la taula "<%=tabla%>"
                        <%end if%>
					<%else%>
						<%if accion="utiliza" then%>
	                        P�ginas donde se utilitza la tabla "<%=tabla%>"
						<%else%>
	                        P�ginas donde se modifica el contenido de la tabla "<%=tabla%>"
                        <%end if%>
					<%end if%>
				</font>
			</td>
