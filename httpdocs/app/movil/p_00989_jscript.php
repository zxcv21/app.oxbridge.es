...
function p_00989_comprobar_firmas_pendientes(){
	...
	if(p_00989_ultimo_dia){
		...
		if((window.innerWidth<p_00956_ancho_movil)&&(window.innerHeight>window.innerWidth)){
			...
			document.getElementById("p_00955_mensaje_usuario").innerText="Por favor, firma en posici�n horizontal";
...
function p_00989_resize_firmas(){
	if(document.getElementById("p_00995_firma").style.display!=="none"){
		if(window.innerWidth<p_00956_ancho_movil){
				...
				//deshace colocar en portrait el menu en el body para que no desaparezca en ios al hacer scroll con la p�gina arriba
