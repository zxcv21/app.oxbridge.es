...
function p_01171_boton_start(){
	//console.info("RECORDAR QUITAR ESTE ONCLICK p_01171:L344");
...
function p_01171_seccion_smile(){
		...
		"	'>341Km</div>"+
		"</div>"+
		"<div id='p_01171_siguiente_transporte_div' style='display:none;'>"+
...
function p_01171_actualizar_progreso(){
	...
	if(typeof smile_datos.smiles_totales.vocabulario.totales !="undefined")
	{
	...
	if(typeof smile_datos.smiles_totales.estructura.totales !="undefined")
	{
	...
	x_tnt=100/smile_datos.trinity_ultimas_respuestas.length*x_tnt;
