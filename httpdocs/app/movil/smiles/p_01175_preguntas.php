...
<div id="p_01175_smile_estructura_ordenar_frase" style='display:none;'>
	<div id="ordenar_frase" class="preguntas" style="display:none;">
		...
		<div id="botonPasarOF" align="right" class="estiloBoton" style='display:none;'><input id="boton_pasar_of" type="image" src="<? echo ver_url("movil/smiles/images/play_grey_70.png","src"); ?>" title="continue without answer" style="position: absolute;right: 10px;bottom: 10px;height: 40px;" onclick="p_01174_skip_pregunta(this.id)"></div>
		<div id="botonOF" align="right" class="estiloBoton"><input id="compruebaOF" type="image" src="<? echo ver_url("movil/smiles/images/play_green_70.png","src"); ?>" title="go next question" style="position: absolute;right: 10px;bottom: 10px;height: 40px;" onclick="p_01174_comprueba_frase_formada_usuario(this.id)"></div>
