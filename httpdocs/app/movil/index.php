...
$var__http__p_00955_php = "http" ;
if( isset($_SERVER['HTTPS']) )
{
    if( $_SERVER['HTTPS'] == "on" )
	{
		$var__http__p_00955_php = "https" ;
    } ;
} ;

?>
<script type="text/javascript">
	console.log("pagina segura movil: <? echo($var__http__p_00955_php) ; ?>") ;
</script>
<?
...
else
{
	...
	function ver_url($url,$tipo)
	{
		...
		else
		{
			...
			if($tipo=="src")
			{
				$r="https://app.oxbridge.es/app".$_SESSION["version__p_php_session"]."/".$url;
			}
		}
		return $r;
	}
