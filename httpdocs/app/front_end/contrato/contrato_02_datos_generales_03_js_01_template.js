...
{
	document.getElementById('p_0010170_img_imagen_guardado').src='http://app.oxbridge.es/app/dev/migue/front_end/contrato/imagenes/guardar_desactivado.png';
...
function p_0010172_js_f_08_comprueba_existe_fecha(p_0010172_js_valor_value,p_0010172_js_valor_id) //comprueba una fecha
{
	...
	{
		document.getElementById('p_0010170_img_imagen_guardado').src='http://app.oxbridge.es/app/dev/migue/front_end/contrato/imagenes/guardar.png';
...
function p_0010172_js_f_11_enviar_formulario_pagadores()
{
	if(navigator.onLine)
	{
		...
		ajax_load_page
		(
			"http://app.oxbridge.es/app/dev/migue/front_end/contrato/update_contrato_02_datos_generales.php",
