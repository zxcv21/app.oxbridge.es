...
<?
	if($p_0010167_carga_inicial) include ( $_SERVER['DOCUMENT_ROOT']."/app/utilities/librerias_10_php_01_basicas.php");
	else if(!function_exists(p_0010015_ver_url) )include($_SERVER['DOCUMENT_ROOT']."/app/dev/admin/admin_01_version_control_10_php_01_file_link.php"); 
?>
	<!-- CODIGO DEL CSS -->
