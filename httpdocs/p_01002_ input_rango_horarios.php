...
//ESCUCHAR CLICK DOWUN
document.getElementById("p_01002_semana").addEventListener("mousedown",p_01002_marcar_horario,false);

//empesar a marcar
function p_01002_marcar_horario(){
