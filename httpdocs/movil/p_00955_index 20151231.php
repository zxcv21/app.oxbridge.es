...
<head>
	...
	<link rel="shortcut icon" href="<? echo ver_url("images/favicon.ico","src"); ?>">
   ...
   <div id="p_00995_tutorial" style="display:none;">
	...
	<div id="contenedor" style="display:none;">
      ...
      <div id="head_oxbridge">
      	<img id="head_oxbridge_img" src="<? echo ver_url("images/OXBRIDGE-logo_2.png","src"); ?>" onClick="">
         <img id="head_oxbridge_beta_img" style="height:50%;position: absolute; z-index:-1;" src="<? echo ver_url("images/beta2.png","src"); ?>">
         <? if(isset($_GET['VER'])){ ?>
         	<span style="position: absolute;z-index: -1;bottom: 0;font-size: 2em;text-transform: uppercase;padding: 0 0.5em;font-family: 'Arial Black', 'Arial Bold', Gadget, sans-serif;"><? echo $_GET['VER'];?></span>
         <? }?>
