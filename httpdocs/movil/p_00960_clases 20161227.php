   ...
   <div id="p_00960_clases_head">
   	<div id="p_00960_clases_head_profe">
            ...
            <div id="p_00960_clases_head_fecha">
					<img src="<? echo ver_url("images/desplegable.png","src"); ?>" id="p_00960_clases_head_fecha_desplegable" onclick="calendario_imprime();cargar_tutorial(6);">
               <span id="p_00960_clases_head_fecha_imprimir" onclick="calendario_imprime();cargar_tutorial(6);" content="telephone=no" >
                  <?
                     echo(date(d)); ?>/<?
                     echo(date(m)); ?>/<?
                     echo(date(Y));
