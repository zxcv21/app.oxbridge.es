...
<!--7.- GENERAR CODIGO SQL -INICIO-->
	...
	<table width="<%=TABLA0700000001ANCHO%>" cellpadding="0" cellspacing="0">
		<TR>
			...
			<td width="<%=TABLA0700000001ANCHOC1%>PX" height="0" id="P0010212T070000000001TR00TD01"></td>
			<td width="<%=TABLA0700000001ANCHOC2%>PX" id="P0010212T070000000001TR00TD02"></td>
			<td width="<%=TABLA0700000001ANCHOC3%>PX" id="P0010212T070000000001TR00TD03"></td>
			<td width="<%=TABLA0700000001ANCHOC4%>PX" id="P0010212T070000000001TR00TD04"></td>
		</TR>
        ...
        END IF%>
		<FORM method="post" action="<%=IRCODIGO%>" target="p_0010208_iframe_codigo_sql">
            <TR>
                <%TDSTYLE="style="""
			...
			call p_0010205_asp_f_01_conexion_base_datos( tipo_bd, "", "", "", bdd, p_0010212_asp_f_01_conexion )
			conn.open(p_0010212_asp_f_01_conexion)
            'conn.open conexion%>
