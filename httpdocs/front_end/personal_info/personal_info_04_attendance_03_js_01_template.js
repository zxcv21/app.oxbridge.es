...
p_0010235_js_objeto_personal_info.cargando=true;
		ajax_load_page("https://app.oxbridge.es/app/dev/dani/front_end/personal_info/recurso.php",p_0010151_id_destino,'',1,p_0010151_js_f_01_imprimir_asistencia);
	}
	else
	{
	console.info(p_0010235_js_objeto_personal_info);
		...
		if(typeof p_0010151_imp_dia!="undefined"){
			if(p_0010151_imp_dia.historica=="1"){
				var p_0010151_icono_clase='<img class="p_0010150_personal_asistencia_boton" onclick="'+
											...
											'"src="https://app.oxbridge.es/app/images/boton_asistencia_sel.png">';
				...
				if(p_0010151_imp_dia.firmado=="0") p_0010151_icono_clase='<img class="manito p_0010150_personal_asistencia_boton" onclick="'+
																	...
																	'"src="https://app.oxbridge.es/app/images/boton_firma_pendiente.png">';
			if(p_0010151_imp_dia.asistencia=="0") p_0010151_icono_clase='<img class="p_0010150_personal_asistencia_boton" src="https://app.oxbridge.es/app/images/boton_asistencia_falta.png">';
				if(p_0010151_imp_dia.lectivo=="0") p_0010151_icono_clase='<img class="p_0010150_personal_asistencia_boton" src="https://app.oxbridge.es/app/images/boton_asistencia_anulada.png">';
